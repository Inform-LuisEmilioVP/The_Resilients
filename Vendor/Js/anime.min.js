...
!(function (n, e) {
	...
	function E(n) {
		if (i.dom(n)) {
			for (
				var e, t = n.style.transform || '', r = /(\w+)\(([^)]*)\)/g, a = new Map();
				(e = r.exec(t));
	...
	function F(n, e, t, r) {
		var a,
			...
			i = E(n).get(e) || u;
		return (
			t && (t.transforms.list.set(e, i), (t.transforms.last = e)), r ? D(n, i, r) : i
		);
	}
	function A(n, e, t, r) {
		switch (T(n, e)) {
	...
	function en(t) {
		...
		function B(n) {
			...
			(M.progress = a((d / e) * 100, 0, 100)),
				...
				d > t && d < l
					? (M.changeBegan ||
							((M.changeBegan = !0), (M.changeCompleted = !1), D('changeBegin')),
					  D('change'),
					  I(d))
					: M.changeBegan &&
					  ((M.changeCompleted = !0), (M.changeBegan = !1), D('changeComplete')),
		...
		return (
			(M.reset = function () {
				...
				((M.reversed && !0 !== M.loop) || ('alternate' === n && 1 === M.loop)) &&
					M.remaining++,
